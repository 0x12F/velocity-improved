...
namespace features::movement {
	...
	namespace {
			...
			bool holding_duck )
		{
			...
			const auto filter = systems::g_tracing.make_player_movement_filter( local_pawn );
	...
	{
		this->m_landing_jump_this_tick = false;
		this->m_landing_fraction = 1.0f;
		...
		this->m_landing_jump_this_tick = true;
		this->m_landing_fraction = *landing;
	}
